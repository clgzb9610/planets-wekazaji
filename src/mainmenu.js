...
mainMenu.prototype = {
    ...
    create:function () {
        ...
        var playButton = game.add.button(250,350,"play",playTheGame,this);
        playButton.scale.x = 0.4;
        playButton.scale.y = 0.4;

        var wakazaji = game.add.button(250,450,"wakazaji",openWekazaj, this);
        wakazaji.scale.x = 0.4;
        wakazaji.scale.y = 0.4;

        var credits = game.add.button(250,550,"credits",null, this);
        credits.scale.x = 0.4;
        credits.scale.y = 0.4;
